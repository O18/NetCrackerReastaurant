...
public class MenuRest {
    ...
    public Set<String> getMenusList(){
        return MenuService.getMenusNames(CATALOG_PATH, REGEX);
    }
    ...
    public void deleteMenu(@PathParam("{menu_name}") String menuName){
        MenuService.deleteMenu(CATALOG_PATH + menuName);
    }
    ...
    public void addCategoryToMenu(CategoryDTO categoryDTO, @PathParam("menu_name") String menuName){
        MenuService.addCategory(categoryDTO, CATALOG_PATH + menuName);
    }
    ...
    public void addDishToMenu(DishDTO dishDTO, @PathParam("category_name") String categoryName,  @PathParam("menu_name") String menuName){
        MenuService.addDish(dishDTO, categoryName, CATALOG_PATH + menuName);
    }
    ...
    public void changeCategory(CategoryDTO newCategoryDTO, @PathParam("category_name") String oldCategoryName, @PathParam("menu_name") String menuName){
        MenuService.changeCategory(newCategoryDTO, oldCategoryName, CATALOG_PATH + menuName);
    }
    ...
    public void changeDish(DishDTO dishDTO,  @PathParam("dish_name") String oldDishName, @PathParam("category_name") String categoryName, @PathParam("menu_name") String menuName){
        MenuService.changeDish(dishDTO, oldDishName, categoryName, CATALOG_PATH + menuName);
    }
